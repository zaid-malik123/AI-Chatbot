               ...
               <div>
                  {chats.map((chat, idx) => {
                     ...
                     return (
                        ...
                        >
                           <div className="text-white font-[200] text-sm">{chat.chatName}</div>
                        </div>
                     );
                  })}
               </div>
               ...
               <div className="bg-transparent w-full h-full flex items-center justify-center">
                  <div className="bg-[#212121] rounded-xl w-[90%] max-w-2xl p-8 shadow-lg">
                     <div className="flex justify-between items-center mb-4">
                        <h3 className="text-white text-xl font-medium">Create new chat</h3>
                        <button
                     ...
                     <p className="text-white/70 mb-4">Start a new conversation. Enter a title below.</p>
                     <input onChange={(e) => setChatInp(e.target.value)} value={chatInp} className="w-full px-4 py-3 rounded-md bg-[#2b2b2b] text-white mb-4 outline-0" placeholder="Chat title (optional)" />
