  ...
  return (
    <div className='w-full h-full inset-0 bg-black/50 absolute z-40 flex items-center justify-center backdrop-blur-[1px] px-5'>
      ...
      <div className='p-5 bg-[#212121] flex flex-col w-[400px] rounded-xl gap-5'>
        ...
        <form onSubmit={handleLogin} className="flex flex-col w-full flex-1 gap-5" >
         ...
         <p onClick={() => navigate(<Register/>)} className="text-sm font-[300] text-[#717070] text-center mb-5 cursor-pointer">Want to create an account ? <span className="text-white">Sign up</span></p>
      </div>
