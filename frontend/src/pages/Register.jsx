...
const Register = ({ onSwitch }) => {
  ...
  // navigation handled by Home overlay; use onSwitch to toggle views
    ...
    <div className="w-full h-full inset-0 bg-black/50 absolute z-40 flex items-center justify-center backdrop-blur-[1px] px-5">
      <div className="p-5 bg-[#212121] flex flex-col w-[400px] rounded-xl gap-5">
        <div className="text-white text-center mt-5">
          ...
          <p className="text-sm font-[200] mt-5">
        ...
        <button className="flex items-center justify-center gap-3 w-full py-4 bg-[#2f2f2f] rounded-3xl mt-5">
          <FcGoogle size={30} />
          <span className="text-[18px] text-white font-[300]">
        ...
        >
          <input
            ...
            value={userName}
            className="px-5 py-4 outline-0 rounded-3xl border border-[#717070] text-white text-[15px] placeholder:text-[#717070] focus:border-white"
          ...
          <input
            ...
            type="text"
          />
          <button className="px-5 py-4 outline-0 rounded-3xl border border-[#717070] bg-white text-black text-[15px]">
            Continue
          </button>
        </form>
        <p
          onClick={() => onSwitch && onSwitch("login")}
          className="text-sm font-[300] text-[#717070] text-center mb-5 cursor-pointer"
        >
